...
<input type="hidden" name="required" value="" />
    ...
    <section>
     <h2>Long Walk to Freedom</h2>
     <p><span style="font-style: normal; font-weight: normal; font-size: medium;"> Nelson Mandela (1995) Publishers: Abacus<br/>
Availability: 1 copy available</span></p>
     <p><a href="long walk to freedom.php"><img src="long walk to freedom.png" width="126" height="183"  alt=""/></a></p>
