...
<input type="hidden" name="required" value="" />
    ...
    <section>
     <h2>Journey to the Higher Realm</h2>
     <p><span style="font-style: normal; font-weight: normal; font-size: medium;"> Zuriel Ann Murphy (2012) Publishers: Authorhouse<br/>
Availability: 1 copy available</span></p>
     <p><img src="journey to the higher realm.jpg" width="119" height="179"  alt=""/></p>
     <p><input name="submit" type="submit" class="button" formaction="reserve.php"value="reserve"></p>
    </section>
    <section>
      <h2>&nbsp;</h2>
    </section>
