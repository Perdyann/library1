...
<li class='field_block' id='field_1_div'><div class='col_label'>
	...
	<div class='col_field'>
	<input type="password" name="field_1"  id="field_1" value="<?php  phpfmg_hsc("field_1"); ?>" class='text_box'>
...
<li class='field_block' id='field_3_div'><div class='col_label'>
	<label class='form_field'>item name or isbn</label> <label class='form_required' >*</label> </div>
	<div class='col_field'>
...
Your item has been renewed. check email for confirmation message
</div>
