...
<!-- end .sidebar1 --></div>
  <article class="content">
    ...
    <p>Hello Member, as much as we are not happy to see you go, we will not like to restrict you from doing what you want to do. Don't forget, to tell us the reason why you are leaving us when you fill the <a href="form.php">membership cancellation form.</a>
    <p>Within 24 hours of filling the membership cancellation form, your account will cease to exist. However, you are always welcome to register with us again.
    <p><a href="form.php"><strong>Cancel Membership Now</strong></a>            
    <p>Goodbye    
    <p><em>Signed: Zurielann Library Management.</em>    
    </form>
    <section></section>
    <section> </section>
    <section>
