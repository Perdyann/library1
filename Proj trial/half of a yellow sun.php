...
<select name="search_results">
  ...
  <option value="" selected="selected">Half of a Yellow Sun</option>
</select>
<br />
...
<input type="hidden" name="required" value="" />
    ...
    <section>
     ...
     <p><span style="font-style: normal; font-weight: normal; font-size: medium;"> Chimamanda Ngozi Adichie (2007) Publishers: Harper Perennial<br/>
Availability: 1 copy available</span></p>
     <p><a href="half of a yellow sun.php"><img src="half of a yellow sun.png" width="121" height="180"  alt=""/></a></p>
     <p>
       <input name="submit" type="submit" class="button" formaction="reserve.php"value="Reserve">
     </p>
    </section>
    <section>
      <h2>&nbsp;</h2>
