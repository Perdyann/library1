...
<!-- end .sidebar1 --></div>
  <article class="content">
    ...
    <p>Hello Member, thanks for opting to renew your item; kindly fill the item renewal form below to renew books
    <p>Please leave atleast 6 hours for changes to reflect in your account. You should receive a confirmation email shortly after you complete the renewal form. Kindly use the link below to Renew items.
    <p><a href="Renewal/form.php">Item Renewal Form</a><a href="form (4).php"></a>            
