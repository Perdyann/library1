...
<!-- end .sidebar1 --></div>
  <article class="content">
    ...
    <p>Hello Member, as much as we are not happy to see you go, we will not like to restrict you from doing what you want to do. Don't forget, you can always register with us again. 
    <p>Good bye!    
